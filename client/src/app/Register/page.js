...
import GoogleLoginUse from '../GoogleLogin/page';
      ...
      <div className="Register-container">
        ...
        <div className="Register-field">
          ...
          <div style={{ marginTop: '20px', textAlign: 'center' }}>
            ...
            <Link style={{ color: '#ccc', fontWeight: '500', textAlign: 'center', paddingLeft: '10px', fontSize: '14px' }} href="/auth?startwith=signIn">Login here</Link>
          </div>
        </div>
      </div>
    </div>
